...
####################################################
# Script written by Cédric Brohée @09/09/10
# +32-71-49206
...
echo "################################################################"
echo "SIPAD - Fail2Ban for Gateway VoIP System automatic configuration"
echo "################################################################"
echo ""
echo "################################################################"
...
action   = iptables[name=SSH, port=ssh, protocol=tcp]
           sendmail-whois[name=SSH, dest=$EMAIL, sender=fail2ban@mail.com]
